  ...
  return (
    <div className="container px-4 px-lg-5 lead">
      ...
      <div className="card text-white bg-secondary my-5 text-center">
        <div className="card-body">
          <div className="row gx-4 gx-lg-5 align-items-center my-5">
            <h1 className="mb-5">Service 1</h1>
      ...
      <div className="card text-white bg-secondary my-5 text-center">
        <div className="card-body">
          <div className="gx-4 gx-lg-5 align-items-center my-5 text-center kbd lead">
            <h1 className="mb-5">Service 2</h1>
            <div className="row gx-4 gx-lg-5 align-items-center my-5">
              <div className="col-lg-5 lead">
                <p>
                  This is a template that is great for small businesses. It
                  ...
                  use this template for any project you want!This is a template
                  that is great for small businesses. It doesn't have too much
                  fancy flare to it, but it makes a great use of the standard
                  Bootstrap core components. Feel free to use this template for
      ...
      <div className="card text-white bg-secondary my-5 text-center">
        <div className="card-body">
          <div className="row gx-4 gx-lg-5 align-items-center my-5">
            <h1 className="mb-5">Service 3</h1>
            <div className="col-lg-7">
              <img
                className="img-fluid rounded mb-4 mb-lg-0"
                src="https://dummyimage.com/900x400/dee2e6/6c757d.jpg"
      ...
      <div className="card text-white bg-secondary my-5 text-center">
        <div className="card-body">
          <div className="gx-4 gx-lg-5 align-items-center my-5 text-center kbd lead">
            <h1 className="mb-5">Service 4</h1>
            <div className="row gx-4 gx-lg-5 align-items-center my-5">
              <div className="col-lg-5 lead">
                <p>
                  This is a template that is great for small businesses. It
